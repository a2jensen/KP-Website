    ...
    return (
        <div className={styles.mainContainer}>
            <div className={styles.infoContainer}>
                ...
                <p className={styles.summary}>Throughout the year KP hosts events to build community and connection! From <br/>
                Friendship Games to Pilipino Awareness Week to KAAmping. KP cultivates growth in <br/>
                every space we walk through. Stay up to date with everthing KP has on our calendar
                </p>
